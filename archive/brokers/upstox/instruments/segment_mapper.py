...
_EXCHANGE_TO_UPSTOX: dict[str, str] = {
    "NSE": "NSE_EQ",
    "BSE": "BSE_EQ",
    "NFO": "NSE_FO",
    "BFO": "BSE_FO",
...
class UpstoxSegmentMapper(SegmentMapper):
    ...
    @classmethod
    def from_wire(cls, wire: str) -> ExchangeSegment:
        return cls.to_safe(wire)

    @classmethod
    def exchange_to_wire(cls, exchange: str, default: str = "NSE_EQ") -> str:
        return _EXCHANGE_TO_UPSTOX.get(exchange, default)
