...
class UpstoxBrokerFactory(BrokerProviderFactory):
    def create(
        ...
        *,
        ...
        # Register Upstox status mappings explicitly (avoids import-time side effect).
        from brokers.upstox.status_mapper import register_mappings as _register_upstox_status
        _register_upstox_status()
