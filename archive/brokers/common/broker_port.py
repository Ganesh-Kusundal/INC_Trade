...
def normalize_tick_frame(data: object) -> dict:
    """Normalize a raw broker tick into a canonical frame dict.

    Shared by all broker ``_on_tick`` closures to avoid duplicated
    ...
    if hasattr(data, "__dict__"):
        return {
            ...
            "exchange": getattr(data, "exchange", "NSE"),
            "ltp": Decimal(str(getattr(data, "ltp", 0))),
