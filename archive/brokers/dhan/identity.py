...
from brokers.dhan.segments import DERIVATIVE_SEGMENTS, EXCHANGE_TO_SEGMENT
...
class DhanIdentityProvider:
    ...
    # Single source of truth: brokers.dhan.segments.DERIVATIVE_SEGMENTS
    _DERIVATIVE_SEGMENTS = DERIVATIVE_SEGMENTS
