...
Usage::
    ...
    from brokers_core.infrastructure.observability import (
        HealthCheck,
        AuditLogger,
        EventMetrics,
        AlertingEngine,
...
from brokers_core.infrastructure.observability.alerting import (
    Alert,
    AlertingEngine,
    AlertLevel,
    AlertRule,
...
from brokers_core.infrastructure.observability.audit import (
    ALERTING_RULES,
    FAILURE_TAXONOMY,
    METRICS_CATALOG,
    AuditEvent,
...
from brokers_core.infrastructure.observability.event_metrics import (
    EventMetrics,
    TimestampedCounter,
)
from brokers_core.infrastructure.observability.health_check import (
...
from brokers_core.infrastructure.observability.opentelemetry_setup import (
    get_tracer,
    otel_available,
    setup_telemetry,
)
from brokers_core.infrastructure.observability.tracing import (
    TraceContext,
    trace_event_handler,
    trace_operation,
)
