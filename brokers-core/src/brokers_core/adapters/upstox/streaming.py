...
from brokers_core.adapters.upstox.config import SEGMENT_TO_EXCHANGE
...
from brokers_core.adapters.upstox.tick_mapper import frame_to_quote, frame_to_tick_dict
...
class UpstoxV3Decoder:
    ...
    def parse(self, raw: bytes) -> list[dict[str, Any]] | None:
        if not raw:
            return None
        try:
            from brokers_core.adapters.upstox.proto.market_feed_pb2 import FeedResponse
