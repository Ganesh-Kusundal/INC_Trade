...
from brokers_core.infrastructure.ssl_hardening import create_pinned_session
...
class UpstoxHttpClient(ResilientHttpClient):
    def __init__(
        ...
        self._base_v2 = base_url_v2 or Upstox.PROD_V2
        self._base_hft = base_url_hft or Upstox.PROD_HFT
