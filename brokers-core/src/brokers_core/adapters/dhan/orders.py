...
from brokers_core.domain import Order, OrderRequest, OrderResponse, Trade
...
from brokers_core.adapters.dhan.mapper import map_order, map_order_response
...
class DhanOrders:
    ...
    def trades(self) -> list[Trade]:
        from brokers_core.adapters.dhan.mapper import map_trade
