...
from brokers_core.infrastructure.reconnect_strategy import run_reconnect_loop
from brokers_core.infrastructure.seq_counter import SequenceCounter
...
class BaseWebSocketStreaming(StreamingPort):
    ...
    def stream(
        self,
        symbol: str,
        exchange: str = DEFAULT_EQUITY_EXCHANGE,
        mode: str = "LTP",
