...
Defines typed configuration for all environment variables used across the system.
Operators set values in .env files; this module provides the schema and defaults.

Usage::

    from brokers_core.config.schema import AppConfig, load_dhan_config, load_upstox_config
