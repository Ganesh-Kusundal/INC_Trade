...
from brokers.market.types.future import Future
from brokers.market.types.index import Index
from brokers.market.types.option import Option
...
def _is_index(symbol: str) -> bool:
    try:
        from brokers.config.indices import is_index
