...
Canonical functions for normalizing trading symbols, exchange identifiers,
and position lookup keys.

Usage::

    from brokers.domain.symbols import normalize_symbol, normalize_exchange, make_position_key
...
def make_position_key(symbol: str, exchange: str) -> str:
    ...
    This is the SINGLE canonical key format used by position-tracking code.
