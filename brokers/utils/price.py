...
def wire_price_or_zero(price: Decimal, *, max_decimals: int = 4) -> float:
    """Convert a positive price to wire float; zero/negative prices become 0.0."""
    if price <= _ZERO:
        return 0.0
    return to_wire_float(price, max_decimals=max_decimals)
