...
class UpstoxStreaming:
    ...
    def _run(self) -> None:
        ...
        while self._running:
            ...
            if self._running:
                logger.warning("upstox_ws_reconnecting", extra={"delay": delay})
                time.sleep(delay)
    ...
    def _on_error(self, ws, error) -> None:
        logger.warning("upstox_ws_error", extra={"error": str(error)})

    def _on_close(self, ws, close_status_code, close_msg) -> None:
        logger.info("upstox_ws_disconnected")
