...
UPSTOX_SEGMENT_RESOLVER = SegmentResolver(
    segment_to_exchange_overrides=_UPSTOX_SEGMENT_OVERRIDES,
    exchange_to_segment=EXCHANGE_TO_SEGMENT,
)

SEGMENT_TO_EXCHANGE = UPSTOX_SEGMENT_RESOLVER.segment_to_exchange
