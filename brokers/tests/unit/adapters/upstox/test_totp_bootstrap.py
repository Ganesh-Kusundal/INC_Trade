...
from brokers.adapters.upstox.auth.exceptions import UpstoxAuthError
...
class TestTotpBootstrap:
    ...
    @patch("brokers.adapters.upstox.auth.token_manager.UpstoxTotpClient")
    @patch("brokers.adapters.upstox.auth.token_manager._parse_expiry_epoch_ms")
