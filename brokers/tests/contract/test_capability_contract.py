...
class CapabilityContractTests:
    ...
    def test_capabilities_exists(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
        assert caps is not None

    def test_capabilities_is_broker_capabilities(self, gateway: BrokerAdapter) -> None:
    ...
    def test_capabilities_broker_id_present(self, gateway: BrokerAdapter) -> None:
        """BrokerCapabilities must expose broker_id."""
        caps = gateway.capabilities()
        assert str(caps.broker_id)

    def test_capabilities_supports_method(self, gateway: BrokerAdapter) -> None:
        """BrokerCapabilities must expose supports() method."""
        caps = gateway.capabilities()
        assert callable(caps.supports)

    def test_capabilities_to_dict(self, gateway: BrokerAdapter) -> None:
    ...
    def test_core_capabilities_present(self, gateway: BrokerAdapter) -> None:
    ...
    def test_supports_returns_bool(self, gateway: BrokerAdapter) -> None:
...
class TestCapabilityContractConformance:
    ...
    def gateway(self) -> BrokerAdapter:
        pytest.skip("No concrete BrokerAdapter fixture provided")
...
class DhanCapabilityContractTests:
    ...
    def test_capabilities_broker_id_is_dhan(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_core_trading_flags_true(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_supports_method_known_features(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_distinctive_super_order_supported(self, gateway: BrokerAdapter) -> None:
        """Dhan uniquely advertises super orders."""
        caps = gateway.capabilities()
        assert caps.supports_super_order is True
        assert caps.supports("super_order") is True

    def test_distinctive_native_slice_order_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_distinctive_mtf_supported(self, gateway: BrokerAdapter) -> None:
        """Dhan supports MTF product type."""
        caps = gateway.capabilities()
        assert caps.supports_mtf is True
        assert "MTF" in caps.product_types

    def test_portfolio_stream_not_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_to_dict_is_json_serializable(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
        d = caps.to_dict()
    ...
    def test_to_dict_supports_keys_match_dataclass(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
        d = caps.to_dict()
...
class UpstoxCapabilityContractTests:
    ...
    def test_capabilities_broker_id_is_upstox(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_distinctive_forever_order_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_distinctive_news_supported(self, gateway: BrokerAdapter) -> None:
        """Upstox is the only adapter advertising a news feed."""
        caps = gateway.capabilities()
        assert caps.supports_news is True
        assert caps.supports("news") is True

    def test_distinctive_portfolio_stream_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_super_order_not_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_native_slice_order_not_supported(self, gateway: BrokerAdapter) -> None:
    ...
    def test_mtf_not_supported(self, gateway: BrokerAdapter) -> None:
...
class PaperCapabilityContractTests:
    ...
    def test_capabilities_broker_id_is_paper(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_no_market_data_features(self, gateway: BrokerAdapter) -> None:
    ...
    def test_no_advanced_order_types(self, gateway: BrokerAdapter) -> None:
    ...
    def test_no_options_support(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
    ...
    def test_latency_class_is_simulated(self, gateway: BrokerAdapter) -> None:
        caps = gateway.capabilities()
