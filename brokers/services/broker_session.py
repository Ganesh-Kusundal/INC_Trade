...
class FacadeBrokerSession:
    ...
    def scanner(self) -> Any:
        ...
        if mkt is None and self._facade is not None:
            mkt = self.market
        if mkt is not None:
            import brokers.market.scanner as _ms
    ...
    def analytics(self) -> Any:
        ...
        import brokers.market.analytics as _ma
    ...
    def trading(self) -> Any:
        ...
        if self._facade is not None:
            import brokers.trading.account_registry as _tar
            import brokers.trading.context as _tc
